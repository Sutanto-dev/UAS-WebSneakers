...
<body>
  ...
  <section id="content">
    ...
    <main>
      ...
      <div class="info-data">
        <div class="card">
          <a href="tambah_data_produk.php" class="btn-tambah">Tambah Data</a>
          <a href="../LapPdf.php" class="btn-cetak">Cetak Data</a>
          <a href="../export_excel.php" class="btn-cetak">Print To Excel</a>
          <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="get">
            <input style="margin-left: 800px; margin-bottom: 10px;" value="<?php if (isset($_GET['search'])) {
              echo $_GET['search'];
            } ?>" name="search" type="text" placeholder=" Search...">
            <button class="btn-search" type="submit" value="Pilih">Pilih</button> <br>
            <?php
            if (isset($_GET['search'])) {
              $search = $_GET['search'];
              $query = "select * from produk where id_sepatu like '%" . $search . "%' or nama_sepatu like '%" . $search . "%' or brand like '%" . $search . "%' ";
