...
<body>
    ...
    <nav class="nav container">
      ...
      <div class="nav__menu" id="nav-menu">
        <ul class="nav__list">
          ...
          <li class="nav__item">
            <a href="account.php" class=" nav__link2">Account</a>
          </li>
        </ul>
  ...
  <section class="recently section" id="recently" style="bottom:150px;">
    <div class="recently__container container grid">
      ...
      <img src="images/contact.png" alt="" class="recently__data" width="100%" style="left:100px;">
    </div>
  </section>
